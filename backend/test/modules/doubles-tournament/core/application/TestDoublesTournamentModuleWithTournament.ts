...
export function createTournamentForTests(tournamentId: string, currentTime: Date, team1Id: string, team2Id: string): TestModuleCore {
  ...
  doublesTournament.executeCommand(createTournamentWithTeams);
