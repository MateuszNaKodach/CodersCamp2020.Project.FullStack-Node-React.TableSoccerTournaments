...
import {
    FindDoublesTournamentById,
    FindDoublesTournamentByIdResult
} from "../../application/query/FindDoublesTournamentById";
...
export function doublesTournamentRouter(
    ...
    const getTournamentTeamsByTournamentId = async (request: Request, response: Response) => {
        ...
        const queryResult = await queryPublisher.execute<FindDoublesTournamentByIdResult>(
