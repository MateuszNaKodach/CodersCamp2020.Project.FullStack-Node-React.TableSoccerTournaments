## Build app locally in docker

1. Run Docker on your machine.
1. Change REACT_APP_MOCK_WITH_MSW to true in `.env` file.
1. Execute `docker-compose -f docker-compose.build.yaml up`

Warning! Currently the solution works only with mocked by MSW response (not real Express server).
